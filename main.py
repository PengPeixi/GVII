...
def parse_args():
    ...
    parser.add_argument('--weights', type=str, default='./pretrain_model_weights/vit_base_patch16_224_in21k.pth',
...
if __name__ == '__main__':
    ...
    if 'RAD' not in args.VQA_dir:
        ...
        eval_loader = DataLoader(eval_dset, batch_size, shuffle=False, num_workers=0, pin_memory=True,
